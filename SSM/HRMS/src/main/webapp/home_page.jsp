        ...
        <table width="100%">
            <tr>
                ...
                <td valign="bottom"
                    ...
                    align="right" width="50%"><font size="3">&nbsp;&nbsp;<strong>Current Admin > </strong>
    ...
    <div region="west" style="width: 200px; height: 500px;"
        ...
        <div class="easyui-accordion">
            <div title="Department Manage"
                ...
                <a href="javascript:openTab(' Department Info','dept_manage.jsp')"
            ...
            <div title="Position Manage"
                ...
                style="padding: 10px; height: 10px;">
                <a href="javascript:openTab(' Position Info','position_manage.jsp')"
                    class="easyui-linkbutton" data-options="plain:true"
            ...
            <div title="Employee Manage" data-options="iconCls:'icon-students' "
                style="padding: 10px">
                <a href="javascript:openTab(' Employee Info','employee_manage.jsp')"
                    class="easyui-linkbutton" data-options="plain:true"
            ...
            <div title="Post Manage"
                ...
                style="padding: 10px; height: 10px;">
                <a href="javascript:openTab(' Post Info','post_manage.jsp')"
                    class="easyui-linkbutton" data-options="plain:true"
            ...
            <div title="System Manage" data-options="iconCls:'icon-item'"
                ...
                <a
                    href="javascript:openTab(' Admin List','admin_manage.jsp','icon-lxr')"
