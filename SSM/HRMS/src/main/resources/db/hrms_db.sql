CREATE DATABASE `hrms_db` DEFAULT CHARACTER SET = `utf8mb4`;
CREATE USER 'hrms'@'localhost' IDENTIFIED BY 'hrmsAdmin888';
...
insert into position_tb(pos_name,pos_description) values('Java course staff','make Java courses'),
                                                        ('front-end engineers','responsible for front-end development');
...
insert into employee_tb values('10001','Tom','male','18211234567','524123456@qq.com','chengdu','Bachelor','1990-4-30',1,1),
                              ('10002','Jack','male','18211234568','524123457@qq.com','chongqing','Master','1986-9-2',1,1),
                              ('10011','Rose','female','18211234580','524198757@qq.com','chengdu','Bachelor','1991-11-21',2,2),
                              ('10012','Anny','female','18211237580','594168757@qq.com','chengdu','Master','1987-5-11',2,2);
